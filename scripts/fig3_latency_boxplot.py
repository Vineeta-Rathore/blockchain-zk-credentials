"""
fig3_latency_boxplot.py
-----------------------
Generates Figure 3:
  "Proof Generation Latency Distribution -- CredentialVerification(8)"

Data source: actual 49 warm-run measurements from
  E:/Blockchain IAM/PhD/build/circuits/latency_raw_n8.json
  (generated by scripts/latency-raw-n8.js, 2026-05-21)

Measurement protocol:
  50 total runs of snarkjs.groth16.fullProve()
  Run 1  = cold-start (WASM module init): excluded
  Runs 2-50 = warm runs (n=49): WASM resident in memory

All individual run markers and the ECDF are plotted directly from
the 49 measured latency values; no synthetic data is used.
"""
