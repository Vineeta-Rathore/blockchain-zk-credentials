...
// CredentialVerification(4) -- 4-attribute variant for scaling comparison.
...
component main {public [issuerPublicKey, schemaHash, challenge, predicateThreshold, predicateAttributeIndex, credentialCommitment, platformId]} = CredentialVerification(4);
