...
component main {public [issuerPublicKey, schemaHash, challenge, predicateThreshold, predicateAttributeIndex, credentialCommitment, platformId]} = CredentialVerification(2);
